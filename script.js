function Prepair() {
    ...
    for(i = 7; i >= 0;i--){
        ...
        document.getElementById("glavna").innerHTML += "<a onclick = 'CheckMov(this);' id = "+[i,j]+" class = "+z+"><img  src = 'imgs/0.png'></a>";
           
        }
    }

   for(i = 0; i < 8;i++){
       document.getElementById("6,"+i).innerHTML = "<img src='imgs/piunC.png' alt=>";
       document.getElementById("6,"+i).name = "piunC";
       document.getElementById("1,"+i).innerHTML = "<img src='imgs/piunB.png' alt=>";
       document.getElementById("1,"+i).name = "piunB"
   }

   for(i = 0; i < 8; i+=7){
        document.getElementById("7,"+i).innerHTML = "<img src='imgs/topC.png' alt=>";
        document.getElementById("7,"+i).name = "topC";
        document.getElementById("7,"+i).classList.add("N");
        document.getElementById("0,"+i).innerHTML = "<img src='imgs/topB.png' alt=>";
        document.getElementById("0,"+i).name = "topB"
        document.getElementById("0,"+i).classList.add("N");
   }

   for(i = 1; i < 7; i+=5){
    document.getElementById("7,"+i).innerHTML = "<img src='imgs/konjC.png' alt=>";
    document.getElementById("7,"+i).name = "konjC";
    document.getElementById("0,"+i).innerHTML = "<img src='imgs/konjB.png' alt=>";
    document.getElementById("0,"+i).name = "konjB"
   }

   for(i = 2; i < 6; i+=3){
    document.getElementById("7,"+i).innerHTML = "<img src='imgs/lovacC.png' alt=>";
    document.getElementById("7,"+i).name = "lovacC";
    document.getElementById("0,"+i).innerHTML = "<img src='imgs/lovacB.png' alt=>";
    document.getElementById("0,"+i).name = "lovacB"
   }

   document.getElementById("0,3").innerHTML = "<img src='imgs/kraljB.png' alt=>";
   document.getElementById("0,3").name = "kraljB";
   document.getElementById("0,3").classList.add("N");
   document.getElementById("7,3").innerHTML = "<img src='imgs/kraljC.png' alt=>";
   document.getElementById("7,3").name = "kraljC";
   document.getElementById("7,3").classList.add("N");



   document.getElementById("0,4").innerHTML = "<img src='imgs/kraljicaB.png' alt=>";
   document.getElementById("0,4").name = "kraljicaB";
   document.getElementById("7,4").innerHTML = "<img src='imgs/kraljicaC.png' alt=>";
...
PromoteWhite = ' <a> <img name = "konjB" src="imgs/konjB.png" alt="" onclick = "Promote(this);"></a><a > <img name = "kraljicaB" src="imgs/kraljicaB.png" alt="" onclick = "Promote(this);"></a><a > <img name = "topB" src="imgs/topB.png" alt="" onclick = "Promote(this);"></a><a > <img name = "lovacB" src="imgs/lovacB.png" alt="" onclick = "Promote(this);"></a>'
PromoteBlack = '<a > <img name = "konjC" src="imgs/konjC.png" alt="" onclick = "Promote(this);"></a><a > <img name = "kraljicaC" src="imgs/kraljicaC.png" alt="" onclick = "Promote(this);"></a><a > <img name = "topC" src="imgs/topC.png" alt="" onclick = "Promote(this);"></a><a > <img name = "lovacC" src="imgs/lovacC.png" alt="" onclick = "Promote(this);"></a>'
imeProma = "";
PromotingFigure = "";
Ampovi = Array();
...
function Promote(pickedOpt){
    ...
    PromotingFigure.innerHTML = "<img src='imgs/"+imeProma+".png' alt=>";
...
function Tuceno(a){
    ...
    if(a[0].name == "kraljB"){ console.log("BELI KRALJ!!!");
        ...
        for(i = 0; i < 8; i++){
            for(j = 0; j < 8;j++){
                if(document.getElementById(i+","+j).name.charAt(parseInt(document.getElementById(i+","+j).name.length)-1) == "C"){
                    ...
                    if(niz[0].name == "piunC"){ niz[1].name = "kraljB";
                       if(Eat(niz,0)){
                        niz[1].name = staroIme;
                        x.name = "kraljC";
                        return true;
        ...
        for(i = 0; i < 8; i++){
            for(j = 0; j < 8; j++){
                if(document.getElementById(i+","+j).name.charAt(parseInt(document.getElementById(i+","+j).name.length)-1) == "B"){
                    ...
                    if(niz[0].name == "piunB"){ niz[1].name = "kraljC";
                        if(Eat(niz,0)){
                        niz[1].name = staroIme;
                        x.name = "kraljB";
                        return true;
...
function CanMove(a,check){  
    ...
    if(a[0].name == "kraljicaB" || a[0].name == "kraljicaC"){
        ...
        if(a[0].id[0] == a[1].id[0]){
           ...
           //z = DisplayN(start,dest,a[0].id[0]);
        z = true;
        ...
        if(z){
           ...
           //z = DisplayD(start,dest,a[0].id[2]);
        z = true;
        if(start == dest) z = false;
        if(start > dest){
            for(i = parseInt(start)-1; i > dest; i--){
